...
const Pin = ({ pin }) => {
  ...
  const savePin = (id) => {
    if (!alreadySaved) {
      ...
      client
        .patch(id)
        .setIfMissing({ save: [] }) // initialize the save array to be an empty array
        .insert("after", "save[-1]", [
          {
            _key: uuidv4(),
      ...
      >
        ...
        {postHovered && (
          <div
            ...
            style={{ height: "100%" }} // manually add height
          >
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <a
                  ...
                  download
                  onClick={(e) => e.stopPropagation()} // stop redirect -> is not going to propagate further through the image
